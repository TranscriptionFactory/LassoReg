...
plotResults = function(resultsdf, orig_df) {
  ...
  ggsave(paste0(getwd(), "/plots/plot_plsr_lasso.png"), plot_plsr, height = 7, width = 7)
  ...
  plot_auc = ggboxplot(auc_matrix %>% 
    ...
    stat_compare_means(method = "t.test", comparisons = list(c("svm", "svm_permute"), 
                                                             c("rf", "rf_permute")))
  ggsave(paste0(getwd(), "/plots/plot_auc_lasso.png"), plot = plot_auc, width = 12, height = 6)
  ...
  ggsave(paste0(getwd(), "/plots/plot_cfm_lasso.png"), plot = plot_cfm, width = 14, height = 6)
